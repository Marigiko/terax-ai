...
const LOCAL_META: Partial<Record<ProviderId, LocalMeta>> = {
  ...
  gateway: {
    ...
    description: "AI Workstation Gateway — model routing, MCP, and memory.",
    modelHint: null,
  },
  openrouter: {
    urlPlaceholder: "",
    ...
    switch (id) {
      ...
      case "gateway":
        return {
          ...
          setBaseURL: setGatewayBaseURL,
          setModelId: setGatewayModelId,
          autoStart: gatewayAutoStart,
          setAutoStart: setGatewayAutoStart,
        };
      default:
        return null;
    }
